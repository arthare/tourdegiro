...
#pragma message("user mode pages!")
...
#pragma message("namespacing!")
    namespace nedalloc {
  #else
#pragma message("not namespacing!")
    extern "C" {
  #endif
#else
  #pragma message("not cplusplus")
#endif

#pragma message("and now I'm here")
